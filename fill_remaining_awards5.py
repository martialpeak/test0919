#!/usr/bin/env python3
"""Fill remaining award notes - exact persian names from DB."""
import json
...
# Exact persian names from DB (verified above)
KNOWN_AWARDS = {
    'آن هاتاوی': [
    ...
    'هویته ون هویتما': [
        ('Academy Award (Oscar)', '2022', 'Best Cinematography', 'Dune', False),
    ],
    'محمود کلاری': [
        ('Academy Award (Oscar)', '1998', 'Best Cinematography', 'The Taste of Cherry', False),
    ],
}
